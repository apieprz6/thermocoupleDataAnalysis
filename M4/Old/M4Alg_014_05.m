...
[minimum, maximum, timeStep, tau, isHeating] = M3Alg2_014_05(coolClean);
sse = M3Calibration_014_05(minimum, maximum, timeStep, tau, coolClean(:,2), coolClean(:,1), isHeating);
fprintf('Cool Clean\t%.2f\t%.2f\t%.4f\t%.4f\t%.4f\n',minimum,maximum,timeStep,tau,sse);
[minimum, maximum, timeStep, tau, isHeating] = M3Alg2_014_05(coolNoise);
sse = M3Calibration_014_05(minimum, maximum, timeStep, tau, coolNoise(:,2), coolNoise(:,1), isHeating);
fprintf('Cool Noise\t%.2f\t%.2f\t%.4f\t%.4f\t%.4f\n',minimum,maximum,timeStep,tau,sse);
[minimum, maximum, timeStep, tau, isHeating] = M3Alg2_014_05(heatClean);
sse = M3Calibration_014_05(minimum, maximum, timeStep, tau, heatClean(:,2), heatClean(:,1), isHeating);
fprintf('Heat Clean\t%.2f\t%.2f\t%.4f\t%.4f\t%.4f\n',minimum,maximum,timeStep,tau,sse);
[minimum, maximum, timeStep, tau, isHeating] = M3Alg2_014_05(heatNoise);
sse = M3Calibration_014_05(minimum, maximum, timeStep, tau, heatNoise(:,2), heatNoise(:,1), isHeating);
