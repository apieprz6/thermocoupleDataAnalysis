function [SSE,SST,r2,m,b] = M4Regr_014_05(tau)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%
% Function Call
% 	[SSE,SST,r2,m,b] = M4Regr_014_05(tau)
%
% Input Arguments
...
text(1.25,20,'Price = 32.918 * 0.051066^t^a^u');
text(1.25,15,'Price = .0510*tau + 32.918');
legend('FOS1','FOS2','FOS3','FOS4','FOS5','Best Fit Curve','Location','northeast');%CHANGE LINE EQUATION TO BE IN RIGHT FORMAT
